...
const orderRoutes = () => {
    ...
    router.get('/active/usr/:user_id', verification_1.default, controller.getActiveOrdersByUserId);
    router.get('/complete/usr/:user_id', verification_1.default, controller.getCompleteOrdersByUserId);
