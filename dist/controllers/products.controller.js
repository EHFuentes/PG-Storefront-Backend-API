...
var model = new products_model_1.ProductsModel();
var ProductsController = /** @class */ (function () {
    function ProductsController() {
    }
    ProductsController.prototype.getAllProducts = function (req, res) {
    ...
    ProductsController.prototype.getProductByCategory = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var product, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, model.productCategory(req.params.product_category)];
                    case 1:
                        product = _b.sent();
                        res.status(200).json(product);
                        return [3 /*break*/, 3];
    ...
    ProductsController.prototype.getTopFive = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var products, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, model.getTopFive()];
                    case 1:
                        products = _a.sent();
                        res.status(200).json(products);
                        return [3 /*break*/, 3];
